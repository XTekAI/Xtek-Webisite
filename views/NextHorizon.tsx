                        ...
                        {[
                            {
                                ...
                                title: "Internal-Only Network",
                                desc: "All data lives on your hardware, behind your firewall. No SaaS dependency, no vendor lock-in, no external routing of sensitive information."
                            },
                            {
                                icon: <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>,
                                title: "End-to-End Encryption",
                                desc: "AES-256 encryption at rest and in transit. Every file, message, and document is protected by military-grade cryptographic standards."
                            },
                            {
                                icon: <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>,
                                title: "Full Audit Trail",
                                desc: "Every action is logged with user identity, timestamp, and IP. Complete regulatory compliance for HIPAA, CJIS, and SOC 2 frameworks."
                            },
                        ].map((card, i) => (
                            <div key={i} className="glass-panel p-8 hover:border-primary-light/30 transition-all duration-300 group">
                                <div className="w-14 h-14 bg-primary-light/10 text-primary-light rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary-light group-hover:text-white transition-all">
                                    {card.icon}
                                </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="nh-row">
                        ...
                        <div className="nh-card">
                            <div className="nh-card__border" />
                            <div className="nh-card__content p-8 lg:p-10">
                                <div className="mb-6">
                                    <div className="w-14 h-14 rounded-xl bg-[#057BA3]/15 flex items-center justify-center mb-5">
                                        <svg className="w-7 h-7 text-primary-light" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                                    </div>
                                    <h3 className="text-2xl font-bold mb-3 !text-white">Organizational Sovereignty</h3>
                                    <p className="text-white/40 text-sm leading-relaxed">
                                        Each department operates within its own cryptographically isolated environment — no cross-contamination, no unauthorized access, no exceptions.
                                    </p>
                                </div>
                                ...
                                <ul className="flex flex-col gap-3.5 mb-8 flex-1">
                                    {[
                                        ...
                                        <li key={i} className="flex items-start gap-3 text-sm text-white/70 leading-relaxed">
                                            <span className="nh-check mt-0.5">
                                ...
                                <a href="#quote" onClick={(e) => handleSmoothScroll(e, 'quote')} className="mt-auto block w-full py-3.5 text-center text-sm font-semibold text-white rounded-full bg-gradient-to-r from-[#057BA3] to-[#0a9dd4] hover:brightness-110 transition-all shadow-lg shadow-[#057BA3]/25">
                                    Request Access
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="nh-card nh-card--accent">
                            ...
                            <div className="nh-card__content p-8 lg:p-10">
                                <div className="mb-6">
                                    <div className="w-14 h-14 rounded-xl bg-[#A7566A]/15 flex items-center justify-center mb-5">
                                    ...
                                    <h3 className="text-2xl font-bold mb-3 !text-white">Next Horizon AI</h3>
                                    <p className="text-white/40 text-sm leading-relaxed">
                                        A private intelligence engine that operates entirely behind your firewall — no cloud dependencies, no third-party data routing, no exposure.
                                    </p>
                                </div>
                                <hr className="border-white/[0.06] mb-6" />
                                <ul className="flex flex-col gap-3.5 mb-8 flex-1">
                                ...
                                <a href="#quote" onClick={(e) => handleSmoothScroll(e, 'quote')} className="mt-auto block w-full py-3.5 text-center text-sm font-semibold text-white rounded-full bg-gradient-to-r from-[#A7566A] to-[#c96b82] hover:brightness-110 transition-all shadow-lg shadow-[#A7566A]/25">
                        ...
                        <div className="nh-card">
                            ...
                            <div className="nh-card__content p-8 lg:p-10">
                                <div className="mb-6">
                                    <div className="w-14 h-14 rounded-xl bg-[#057BA3]/15 flex items-center justify-center mb-5">
                                        <svg className="w-7 h-7 text-primary-light" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                                    </div>
                                    <h3 className="text-2xl font-bold mb-3 !text-white">Unified Operations</h3>
                                    <p className="text-white/40 text-sm leading-relaxed">
                                        End-to-end encrypted coordination for leadership briefings, department alerts, and governance workflows — all within the vault.
                                    </p>
                                </div>
                                <hr className="border-white/[0.06] mb-6" />
                                <ul className="flex flex-col gap-3.5 mb-8 flex-1">
